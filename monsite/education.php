...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
  ...
  <section class="add-experience-section p-3 p-lg-5 d-flex justify-content-left" id="">
        <div class="w-100">
          <h2 class="mb-5">Ajouter une Ecole</h2>

            <form method="POST" action="education.php">
              <div class="form-group mx-sm-3 mb-3">
                <label for="Ecole">Ecole :</label>
                <input class="form-control form-control-sm" name="Ecole" id="Ecole" type="text" style="width:500px">
              </div>

              <div class="form-group mx-sm-3 mb-3">
                <label for="Cursus">Cursus :</label>
                <input class="form-control form-control-sm" name="Cursus" id="Cursus" type="text" style="width:500px">
              </div>
    ...
    if (isset($_POST['add'])){
        ...
        $choix = $bdd->query('SELECT * FROM education');
        $Ecole = $_POST['Ecole'];
        $cursus = $_POST['Cursus'];
        $duree = $_POST['duree'];

        $ajout = $bdd->query("INSERT INTO education (Ecole,Cursus,duree) VALUES ('$Ecole','$cursus','$duree')");
